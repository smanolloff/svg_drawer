    ...
    class Base
      ...
      class << self
        ...
        def special(*names)
          ...
          default_params.reverse_merge!(names.map { |n| [n, nil] }.to_h)
      ...
      def initialize(params = {})
        ...
        @inherited_params = {}
        @child_params = {}
        @pmerger = ParameterMerger.new(@params, @inherited_params, self.class.default_params)
      ...
      def update_params!(params)
        ...
        @child_params = @inherited_params.merge(@params).except(*self.class.special_params)
